...
function renderPayPalButton() {
  ...
  const options = {
    /**
     * Create an order with the following options
     */
    ...
    /**
     *  Calling onAuthorizeTransaction when the order gets approved.
     */
    onApprove: function (data, actions) {
      onAuthorizeTransaction(data.orderID); //Passing the orderID returned by createOrder
    },
  };

  /**
   *  Render the button with the options passed above.
   */
